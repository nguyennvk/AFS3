...
const DropDownMenu = () => {
  return (
    <div className="flex justify-center bg-neutral-900 px-3 py-2 text-neutral-200 rounded-md">
...
const PricingContent = () => {
  ...
  return (
    <div className="w-64 bg-blue-700 p-6 shadow-xl">
